...
export const translations = {
  ko: {
    ...
    feedSortRecent: "최신순",
    feedSortTitle: "제목순",
    feedSearchLabel: "행사 검색",
    feedSearchPlaceholder: "행사 제목, 장소 또는 기관을 검색",
    feedSearchAria: "행사 검색어 입력",
    feedSearchClearAria: "검색어 지우기",
    feedSearchEmpty: "일치하는 행사가 없습니다.",
    feedSearchEmptyDesc: "검색어를 바꾸거나 다른 필터를 선택해보세요.",
    feedScrollTopAria: "최상단으로 이동",
  ...
  en: {
    ...
    feedSearchLabel: "Search events",
    feedSearchPlaceholder: "Search by title, venue, or organization",
    feedSearchAria: "Enter a keyword to search events",
    feedSearchClearAria: "Clear search",
    feedSearchEmpty: "No events match that search.",
    feedSearchEmptyDesc: "Try a different keyword or adjust the filters.",
    feedScrollTopAria: "Back to top",
